...
import com.menggp.artifactstore.restService.services.ArtifactCrudReadHandler;
...
public class DataReadController {
    ...
    public Comment getCommentById(
        ...
        return commentCrudHandler1.findCommentById( id );
    } // emd_method
    ...
    public CommentList getCommentsByArtifact(
        ...
        commentList = commentCrudHandler1.findByArtifactId( id );
